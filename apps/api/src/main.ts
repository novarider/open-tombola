...
Container.set('db-port', process.env.DB_PORT ? Number(process.env.DB_PORT) : 5432);
Container.set('db-username', process.env.DB_USERNAME ? process.env.DB_USERNAME : 'user');
